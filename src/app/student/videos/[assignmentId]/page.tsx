...
export default async function Lesson({params}:{params:Promise<{assignmentId:string}>}){
 ...
 const {data:raw,error}=await supabase.rpc("get_video_player_data",{p_assignment_id:assignmentId}).single();
